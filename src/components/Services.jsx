...
const Services = () => {
    ...
    return (
                            ...
                            <form className="space-y-4" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 h-24 block w-full p-2.5"
                                        required
                                    />
                                </div>
                                <button
        ...
        <div className="flex justify-center mt-5">
            <button
                onClick={toggleModal}
                className="text-white bg-black focus:ring-4 md:text-3xl text-1xl rounded-xl font-semibold text-sm px-10 py-2.5"
                >
                Get Expert Advice
                </button>
        </div>
